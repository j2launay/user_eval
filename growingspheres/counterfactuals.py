...
class CounterfactualExplanation:
    ...
    """
    def __init__(self, prediction_fn, target_class=None, random_state=None,
                continuous_features=None, categorical_features=[], categorical_values=[], 
                max_features=[], min_features=[],  n_in_layer=2000, first_radius=0.01, 
    ...
    def fit(self, obs_to_interprete, sparse=True, verbose=False, 
        ...
        cf = self.methods_["GF"](self.obs_to_interprete,
                self.prediction_fn,
